...
class CatListFontSizeTile extends StatefulWidget {
  @override
  State createState() => _CatListFontSizeTileState();
}

class _CatListFontSizeTileState extends State<CatListFontSizeTile> {
        ...
        trailing: SizedBox(
            ...
            child: Column(
                ...
                children: <Widget>[
                  ...
                  BlocBuilder<PreferenceEvent, PreferenceState>(
                        ...
                        return Slider(
                            ...
                            onChanged: (value) {
                              ...
                              if (state is PreferenceLoaded) {
                                var pref =
                                    state.preferences[CAT_LIST_FONT_SIZE];
                                pref.value = value;
                                _preferenceBloc
